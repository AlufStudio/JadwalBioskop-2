package com.example.irwancannady.jadwalbioskop.util;
...
public class FlowLayout extends ViewGroup {
    ...
    private void init() {
        paddingHorizontal = getResources().getDimensionPixelSize(R.dimen.margin);
        paddingVertical = getResources().getDimensionPixelSize(R.dimen.margin);
    }
